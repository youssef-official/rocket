...
export const Docs: React.FC = () => {
  ...
  const sections = [
      ...
      content: [
        {
          ...
          description: 'Vivora X uses an intelligent Agent Loop for code generation — the AI doesn\'t just generate code once. It plans, generates, validates, and fixes automatically to deliver higher quality results.',
        },
        {
          title: 'How the Agent Loop Works',
          description: 'The agent goes through multiple steps:',
          steps: [
            'PLAN — The AI analyzes your request and creates a structured plan (goals, subtasks, files needed, complexity)',
            'GENERATE — Full code generation with the plan injected for better context',
            'VALIDATE — The AI reviews its own code checking for missing imports, broken exports, undefined variables, and syntax errors',
            'FIX — If confidence is below 85%, the AI automatically patches broken parts (up to 2 iterations)',
            'STREAM — The final validated code is streamed live to your editor',
          ],
        },
        {
          title: 'Live Progress Tracking',
          description: 'Watch the agent\'s progress in real-time on the version card — each step shows its status with confidence scores and issue counts.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          title: 'Cloud-Synced Music Player',
          description: 'Vivora X includes a professional floating music player with cloud-synced playlists. Your tracks, favorites, and preferences are saved to your account — accessible from any device.',
        },
        {
          title: 'How to Use',
          ...
          steps: [
            ...
            'The floating player appears — drag it anywhere on screen (desktop & mobile)',
            'Click "Add Track" in the Playlist tab and paste an MP3 URL',
            'Use the timeline seek bar to jump to any position in the track',
        ...
        },
        {
          ...
          steps: [
            'Cloud sync — playlists saved to your account, not just local storage',
            'Interactive timeline seek bar with time display (current / total)',
            'Draggable anywhere — works on desktop and mobile with touch support',
            'Mini player mode with progress ring indicator',
            'Vinyl-style rotating album art animation during playback',
            'Playlist management with unlimited tracks',
            'Favorites section for quick access to loved tracks',
            'Volume control with percentage display',
            'Repeat mode for looping tracks',
            'Cloud sync indicator (syncing / synced / offline)',
            'Persistent across all pages — music keeps playing while navigating',
          ],
        },
      ],
    },
