...
export const translations: Translations = {
  ...
  // Home page
  'home.title1': { en: 'Think It.', ar: 'تخيله.', zh: '想一想.', ja: '考えて.', fr: 'Pensez-y.' },
  'home.title2': { en: 'Type It.', ar: 'اكتبه.', zh: '输入它.', ja: '入力して.', fr: 'Tapez-le.' },
  'home.title3': { en: 'Launch It.', ar: 'أطلقه.', zh: '启动它.', ja: '起動して.', fr: 'Lancez-le.' },
  'home.subtitle': { en: 'Build production-ready', ar: 'ابنِ صفحات هبوط جاهزة للإنتاج', zh: '构建生产就绪', ja: '本番対応の構築', fr: 'Créez des applications prêtes' },
  ...
  'home.mobileAnnouncement': { en: 'Vivora X: A New Vibe Coding Tool', ar: 'جديد: Vivora X: أداة ترميز جديدة كلياً', zh: 'Vivora X: 全新的 Vibe Coding 工具', ja: 'Vivora X: 新しい Vibe Coding ツール', fr: 'Vivora X: Un nouvel outil de Vibe Coding' },
  ...
  'editor.rename': { en: 'Rename...', ar: 'إعادة تسمية...', zh: '重命名...', ja: '名前を変更...', fr: 'Renوممر...' },
  ...
  'projects.count': { en: '{count} project{s}', ar: '{count} مشاريع', zh: '{count} 个项目', ja: '{count} 件のプロジェクト', fr: '{count} projet{s}' },
  ...
  'footer.integrations': { en: 'Integrations', ar: 'التكاملات', zh: '集成', ja: '統合', fr: 'الانتجراسيون' },
  ...
  'chat.changesApplied': { en: 'Changes applied!', ar: 'تم تطبيق التغييرات!', zh: '更改已应用!', ja: '更改が適用されました!', fr: 'Modifications appliquées!' },
  ...
  'chat.built': { en: 'Built the project to ensure everything works', ar: 'تم بناء المشروع للتأكد من أن كل شيء يعمل', zh: '构建项目以确保一切正常', ja: 'すべてが機能することを確認するためにプロジェクトをビルدしました', fr: 'Projet construit pour s\'assurer que tout fonctionne' },
