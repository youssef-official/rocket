...
export const translations: Translations = {
  ...
  'home.mobileAnnouncement': { en: 'Vivora X: A New Vibe Coding Tool', zh: 'Vivora X: 全新的 Vibe Coding 工具', ja: 'Vivora X: 新しい Vibe Coding ツール', fr: 'Vivora X: Un nouvel outil de Vibe Coding' },
  ...
  'editor.connectGitHub': { en: 'Connect to GitHub', zh: '连接到 GitHub', ja: 'GitHubに接続', fr: 'Connecter à GitHub' },
  'editor.connectedGitHub': { en: 'Connected to GitHub', zh: '已连接到 GitHub', ja: 'GitHubに接続済み', fr: 'Connecté à GitHub' },
  'editor.deployVercel': { en: 'Deploy to Vercel', zh: '部署到 Vercel', ja: 'Vercelにデプロイ', fr: 'Déployer sur Vercel' },
  'editor.deployedVercel': { en: 'Deployed to Vercel', zh: '已部署到 Vercel', ja: 'Vercelにデプロイ済み', fr: 'Déployé sur Vercel' },
  ...
  'editor.database': { en: 'Database', zh: '数据库', ja: 'データベース', fr: 'Base de données' },
  'editor.repoName': { en: 'Repository name', zh: '仓库名称', ja: 'リポジトリ名', fr: 'Nom du dépôt' },
  'editor.syncToGitHub': { en: 'Sync to GitHub', zh: '同步到 GitHub', ja: 'GitHubに同期', fr: 'Synchroniser avec GitHub' },

  // Projects
  'projects.title': { en: 'Your Projects', zh: '您的项目', ja: 'あなたのプロジェクト', fr: 'Vos projets' },
  'projects.empty': { en: 'No projects yet', zh: '暂无项目', ja: 'プロジェクトはまだありません', fr: 'Aucun projet' },
  'projects.createFirst': { en: 'Create your first project', zh: '创建您的第一个项目', ja: '最初のプロジェクトを作成', fr: 'Créez votre premier projet' },
  'projects.newProject': { en: 'New Project', zh: '新项目', ja: '新規プロジェクト', fr: 'Nouveau projet' },
  'projects.openProject': { en: 'Open Project', zh: '打开项目', ja: 'プロジェクトを開く', fr: 'Ouvrir le projet' },
  'projects.fork': { en: 'Fork', zh: '分叉', ja: 'フォーク', fr: 'Forker' },
  'projects.delete': { en: 'Delete', zh: '删除', ja: '削除', fr: 'Supprimer' },
  'projects.viewAll': { en: 'View all {count} projects', zh: '查看所有 {count} 个项目', ja: '全 {count} 件のプロジェクトを表示', fr: 'Voir les {count} projets' },
  'projects.count': { en: '{count} project{s}', zh: '{count} 个项目', ja: '{count} 件のプロジェクト', fr: '{count} projet{s}' },
  ...
  'docs.github': { en: 'GitHub Integration', zh: 'GitHub集成', ja: 'GitHub連携', fr: 'Intégration GitHub' },
  'docs.vercel': { en: 'Vercel Deployment', zh: 'Vercel部署', ja: 'Vercelデプロイ', fr: 'Déploiement Vercel' },
  ...
  'chat.placeholder': { en: 'How can Vivora X help you today?', zh: 'Vivora X今天能为您做什么?', ja: '今日はVivora Xがどのようにお手伝いできますか?', fr: 'Comment Vivora X peut-il vous aider aujourd\'hui?' },
  'chat.planPlaceholder': { en: 'Plan with Vivora X (no code changes)...', zh: '与Vivora X规划（不更改代码）...', ja: 'Vivora Xと計画（コード変更なし）...', fr: 'Planifier avec Vivora X (pas de changement de code)...' },
  ...
  // Integrations
  'integrations.githubConnected': { en: 'Your project is connected to GitHub!', zh: '您的项目已连接到 GitHub!', ja: 'プロジェクトはGitHubに接続されています!', fr: 'Votre projet est connecté à GitHub !' },
  'integrations.githubConnectDesc': { en: 'Connect your project to GitHub for 2-way sync.', zh: '将您的项目连接到 GitHub 以进行双向同步。', ja: 'プロジェクトをGitHubに接続して双方向同期を行います。', fr: 'Connectez votre projet à GitHub pour une synchronisation bidirectionnelle.' },
  'integrations.githubNotConnected': { en: 'GitHub not connected', zh: 'GitHub 未连接', ja: 'GitHubが接続されていません', fr: 'GitHub non connecté' },
  'integrations.githubConnectSettings': { en: 'Please connect your GitHub account in Settings first.', zh: '请先在设置中连接您的 GitHub 帐户。', ja: 'まず設定でGitHubアカウントを接続してください。', fr: 'Veuillez d\'abord connecter votre compte GitHub dans les paramètres.' },
  'integrations.goToSettingsGithub': { en: 'Go to Settings to connect your GitHub account first.', zh: '前往设置以先连接您的 GitHub 帐户。', ja: '設定に移動して、まずGitHubアカウントを接続してください。', fr: 'Allez dans les paramètres pour connecter votre compte GitHub d\'abord.' },
  ...
  'integrations.syncDesc': { en: 'Any changes made in GitHub will sync back to your project and create a new version.', zh: '在 GitHub 中所做的任何更改都将同步回您的项目并创建一个新版本。', ja: 'GitHubで行われた変更はプロジェクトに同期され、新しいバージョンが作成されます。', fr: 'Toute modification apportée dans GitHub sera synchronisée avec votre projet et créera une nouvelle version.' },
  ...
  'integrations.vercelDeployed': { en: 'Your site is deployed!', zh: '您的网站已部署!', ja: 'サイトがデプロイされました!', fr: 'Votre site est déployé !' },
  'integrations.vercelDeployDesc': { en: 'Deploy your project to Vercel.', zh: '将您的项目部署到 Vercel。', ja: 'プロジェクトをVercelにデプロイします。', fr: 'Déployez votre projet sur Vercel.' },
  'integrations.vercelNotConnected': { en: 'Vercel not connected', zh: 'Vercel 未连接', ja: 'Vercelが接続されていません', fr: 'Vercel non connecté' },
  'integrations.vercelConnectSettings': { en: 'Please connect your Vercel account in Settings first.', zh: '请先在设置中连接您的 Vercel 帐户。', ja: 'まず設定でVercelアカウントを接続してください。', fr: 'Veuillez d\'abord connecter votre compte Vercel dans les paramètres.' },
  'integrations.goToSettingsVercel': { en: 'Go to Settings to connect your Vercel account first.', zh: '前往设置以先连接您的 Vercel 帐户。', ja: '設定に移動して、まずVercelアカウントを接続してください。', fr: 'Allez dans les paramètres pour connecter votre compte Vercel d\'abord.' },
  ...
  'integrations.vercelDesc': { en: 'Deploy your projects to Vercel with one click.', zh: '一键将您的项目部署到 Vercel。', ja: 'ワンクリックでプロジェクトをVercelにデプロイします。', fr: 'Déployez vos projets sur Vercel en un clic.' },
