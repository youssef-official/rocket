        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              className="fixed right-0 top-0 h-full w-80 sm:w-96 bg-gray-900/95 backdrop-blur-xl border-l border-white/10 z-[9999] overflow-y-auto shadow-2xl"
            >
              ...
              {filteredNotifs.length === 0 ? (
                ...
                <div className="divide-y divide-white/5">
                  {filteredNotifs.map(n => (
                    <div
                      key={n.id}
                      className={`p-4 hover:bg-white/5 transition-colors cursor-pointer ${!readIds.has(n.id) ? 'bg-pink-500/5' : ''}`}
                    ...
                    >
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {n.body && <p className="text-xs text-white/50 mt-1 line-clamp-2">{n.body}</p>}
