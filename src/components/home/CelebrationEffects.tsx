...
const confetti = Array.from({ length: 30 }, (_, index) => ({ id: `confetti-${index}`, left: (index * 17) % 100, delay: (index % 8) * 0.4, color: ['bg-pink-400','bg-fuchsia-400','bg-emerald-400','bg-sky-400'][index % 4] }));
